...
"""
Purpose:
    Integration-style OMAPS dataset test that reads actual sample clips/labels
...
def _resolve_cfg() -> tuple[dict, str]:
    ...
    cfg_path = repo_root / "configs" / "dataset" / "omaps.yaml"
    ...
    return {
        "dataset": {
            **dataset_cfg,
            ...
            "num_workers": 0,
            "require_labels": bool(list(split_path.rglob("*.txt"))),
        }
    }, split
