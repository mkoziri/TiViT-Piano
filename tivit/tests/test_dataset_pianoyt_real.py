...
"""
Purpose:
    Integration-style PianoYT dataset test that reads actual sample clips/labels
    from the dataset's test split.

Usage:
    python tivit/tests/test_dataset_pianoyt_real.py
"""
...
def _resolve_cfg() -> tuple[dict, str]:
    ...
    cfg_path = repo_root / "configs" / "dataset" / "pianoyt.yaml"
